...
class hs extends Bt {
  ...
  showNestedPopoverForItem(e) {
    ...
    return t.getElement().classList.add(
      P.getPopoverNestedClass(t.nestingLevel)
    ), t;
  }
  /**
   ...
   */
  handleItemClick(e) {
    e !== this.nestedPopoverTriggerItem && super.destroyNestedPopoverIfExists(), super.handleItemClick(e);
  }
}
const on = class xe {
  constructor() {
